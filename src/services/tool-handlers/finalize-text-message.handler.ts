...
function buildFinalTextDeveloperMessage(): string {
    return [
        ...
        "Baseie-se somente no schema de colunas e nos dados de amostra recebido no output da tool.",
        "Os dados de amostra contem os 10 primeiros registros sem ofuscacao.",
